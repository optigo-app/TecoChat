...
const DOC_ICON_MAP: Record<string, DocumentMeta> = {
  pdf: { iconName: "FileText", label: "PDF", tone: "pdf", iconUrl: "/icons/pdf.png" },
  doc: { iconName: "FileText", label: "DOCS", tone: "doc", iconUrl: "/icons/doc.png" },
  docx: { iconName: "FileText", label: "DOCS", tone: "doc", iconUrl: "/icons/doc.png" },
  dcs: { iconName: "FileText", label: "DOCS", tone: "doc", iconUrl: "/icons/doc.png" },
  rtf: { iconName: "FileText", label: "DOCS", tone: "doc", iconUrl: "/icons/doc.png" },
  txt: { iconName: "FileText", label: "TEXT", tone: "default", iconUrl: "/icons/txt.png" },
  log: { iconName: "FileText", label: "TEXT", tone: "default", iconUrl: "/icons/txt.png" },
  md: { iconName: "FileText", label: "TEXT", tone: "default", iconUrl: "/icons/txt.png" },
  xls: { iconName: "FileSpreadsheet", label: "EXCEL", tone: "sheet", iconUrl: "/icons/xls.png" },
  xlsx: { iconName: "FileSpreadsheet", label: "EXCEL", tone: "sheet", iconUrl: "/icons/xls.png" },
  csv: { iconName: "FileSpreadsheet", label: "EXCEL", tone: "sheet", iconUrl: "/icons/xls.png" },
  ppt: { iconName: "FileType", label: "PPT", tone: "ppt", iconUrl: "/icons/ppt.png" },
  pptx: { iconName: "FileType", label: "PPT", tone: "ppt", iconUrl: "/icons/ppt.png" },
  zip: { iconName: "FileArchive", label: "ZIP", tone: "archive", iconUrl: "/icons/zip.png" },
  rar: { iconName: "FileArchive", label: "RAR", tone: "archive", iconUrl: "/icons/rar.png" },
  "7z": { iconName: "FileArchive", label: "7Z", tone: "archive", iconUrl: "/icons/7z.png" },
  psd: { iconName: "FileType", label: "PSD", tone: "psd", iconUrl: "/icons/psd-file.png" },
  apk: { iconName: "Smartphone", label: "APK", tone: "apk", iconUrl: "/icons/apk.png" },
  js: { iconName: "FileCode", label: "CODE", tone: "code", iconUrl: "/icons/java-script.png" },
  ...
  css: { iconName: "FileCode", label: "CODE", tone: "code", iconUrl: "/icons/css-3.png" },
  py: { iconName: "FileCode", label: "PYTHON", tone: "code", iconUrl: "/icons/python.png" },
  sql: { iconName: "FileCode", label: "DATABASE", tone: "code", iconUrl: "/icons/database.png" },
  svg: { iconName: "FileImage", label: "SVG", tone: "image", iconUrl: "/icons/svg.png" },
  eps: { iconName: "FileImage", label: "SVG", tone: "image", iconUrl: "/icons/svg.png" },
  mp3: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  wav: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  ogg: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  m4a: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  flac: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  aac: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  wma: { iconName: "FileAudio", label: "AUDIO", tone: "audio", iconUrl: "/icons/audio.png" },
  mp4: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  mov: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  avi: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  mkv: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  flv: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  wmv: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  m4v: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
  webm: { iconName: "FileVideo", label: "VIDEO", tone: "video", iconUrl: "/icons/video.png" },
};

export const getDocumentMeta = (filename: string): DocumentMeta => {
  const ext = getFileExt(filename);
  return DOC_ICON_MAP[ext] || { iconName: "File", label: ext.toUpperCase() || "FILE", tone: "default", iconUrl: "/icons/doc.png" };
};

// ── Media dimensions helper ──────────────────────────────────────────────────
...
export const validateMediaFiles = (files: File[]): ValidateResult => {
  ...
  if (acceptedFiles.length > MAX_FILE_COUNT) {
    skippedCount = acceptedFiles.length - MAX_FILE_COUNT;
    acceptedFiles.length = MAX_FILE_COUNT;
  }

  return { acceptedFiles, skippedSize, skippedTotal, skippedCount };
};
