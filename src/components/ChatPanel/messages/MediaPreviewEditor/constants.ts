...
export const WA_TEXT_COLORS = ["#3b4a54", "#8696a0", "#ffffff", "#00d7ff", "#25d366", "#9c27b0", "#ff7a00", "#ff3b30"];
...
export const FONT_FAMILIES = [
  { id: "system" as const, label: "Sans Serif", font: "sans-serif" },
  { id: "serif" as const, label: "Serif", font: "Georgia, serif" },
  { id: "monospace" as const, label: "Monospace", font: "Courier New, monospace" },
  { id: "cursive" as const, label: "Cursive", font: "Pacifico, cursive" },
